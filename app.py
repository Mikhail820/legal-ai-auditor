...
if "GOOGLE_API_KEY" in st.secrets:
    ...
    # Используем ТОЛЬКО проверенную модель 2.5
...
with col_info3 := m3: # Косметическая правка для стабильности
        ...
        if f_old and f_new:
            with st.spinner("Сравниваю..."):
                try:
                    ...
                    diff_prompt = f"Сравни два договора. Найди все изменения. Убедись, что наши правки внесены. \n1: {t_old[:9000]} \n2: {t_new[:9000]}"
